create table movie (movie_id CHAR(16) FOR BIT DATA not null, created timestamp not null, genre varchar(255), screenwriter varchar(255), title varchar(255), updated timestamp not null, primary key (movie_id))
